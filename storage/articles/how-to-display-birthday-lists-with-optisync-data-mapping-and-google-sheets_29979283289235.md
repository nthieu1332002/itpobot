...
3. |  |
   ...
   1. ### Option 3: Repeater Component
      ...
      1. Select a **Template design** *(e.g., Birthday)*
      ...
      1. ---
         ...
         **Step 3**: Enter the SORT Formula
         ...
         1. **={"Celebrant Name", "Birthdate";**
            * **Celebrant Name**" and "**Birthdate**" at the top of the sorted list. The **semicolon** **;** tells Google Sheets to display the sorted data below these headers.
         ...
         * You will now be brought to this page:
           ...
           1. Here is what your design will look like when pushed to screens.
...
Source: https://support.optisigns.com/hc/en-us/articles/29979283289235-How-to-Display-Birthday-Lists-with-OptiSync-Data-Mapping-and-Google-Sheets
