...
* **OptiSigns Pro Player** or [**ProMax Player**](https://www.optisigns.com/product/hardware/promax-digital-signage-player)
* |  |
  | --- |
  | **NOTE** |
  ...
  + ### Video Wall Orientations and Pixel Sizes
    ...
    **Primary Zone** - Setting one of your screens as a Primary Zone will provide a better experience or smoother content transition when you need to coordinate contents in different zones and put use the video wall app in a playlist.
    ...
    - Advanced Playlist Item Playback Control and Campaign Management.
      ...
      * ---
        ...
        1. #### Option 1: Dragging the App to Fill Up All Screens
...
Source: https://support.optisigns.com/hc/en-us/articles/33382537925267-Making-a-Video-Wall-with-OptiSigns-Video-Wall-App
