...
1. **OptiSigns OptiStick** to run OptiSigns on it. Follow [**this guide**](https://support.optisigns.com/hc/en-us/articles/27267311796243) to learn how to set up your OptiSigns Player
2. **Downloads** page to see if our app can be installed on it.
3. **Windows Player app** or [**MacOS Player app**](https://links.optisigns.com/mac) and use your laptop as test screen.
...
* **How to Create and Use Playlists:** If you'd like to have a series of rotating content on your screen
* **How to Create Split Screen Layout:** If you want to split your screen into zones to show different content.
...
* birthdays, [holidays](https://canvas.optisigns.com/templates/category/Holidays%20and%20Observances), [anniversaries](https://canvas.optisigns.com/templates/search/anniversary), [announcements](https://canvas.optisigns.com/templates/search/announcement), etc.
* Weather app.
* Split Screen app.
* Schedules or use the [Live & Expire](https://support.optisigns.com/hc/en-us/articles/360042736794) feature.
* Invite a team member to help you manage your screens.

## **That's it!**

---

Source: https://support.optisigns.com/hc/en-us/articles/18823504383891-OptiSigns-Getting-Started-Guide
