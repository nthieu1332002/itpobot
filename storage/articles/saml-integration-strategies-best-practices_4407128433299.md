...
* SAML SSO with Okta
* SAML SSO with MS Entra ID
* SAML SSO with OneLogin
* SAML SSO with OneLogin (Shibboleth)
...
Source: https://support.optisigns.com/hc/en-us/articles/4407128433299-SAML-Integration-Strategies-Best-Practices
